...
/* harmony import */ var _modules_acordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/acordion */ "./src/js/modules/acordion.js");
...
/* harmony import */ var _modules_filtration__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/filtration */ "./src/js/modules/filtration.js");
...
/* harmony import */ var _modules_showPicture__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/showPicture */ "./src/js/modules/showPicture.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_12__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_12__["default"])('.main-slider-item', 'vertical');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])(statePicture);
  ...
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])(statePicture);
  Object(_modules_filtration__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_showPicture__WEBPACK_IMPORTED_MODULE_11__["default"])();
  Object(_modules_acordion__WEBPACK_IMPORTED_MODULE_0__["default"])('.accordion-heading', '.accordion-block');
  Object(_modules_burgerMenu__WEBPACK_IMPORTED_MODULE_1__["default"])('.burger-menu', '.burger');
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_9__["default"])();
...
var acordion = function acordion(triggerSelector, itemsSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (acordion); // const btns = document.querySelectorAll('..accordion-heading');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(menuSelector, burgerMenu) {
  var menuElem = document.querySelector(menuSelector);
  var burgerElem = document.querySelector(burgerMenu);
...
var calc = function calc(state) {
  ...
  var inputDiscount = document.querySelector('.promocode');
  var sum = 0;
  var promocod = 'IWANTPOPART';

  function costCalculation(target) {
    var selectTextValue = target.options[target.selectedIndex].textContent.trim();
  ...
  function getValue(url, event) {
    ...
    var textValue = target.options[target.selectedIndex].textContent.trim();
    Object(_services_reqests__WEBPACK_IMPORTED_MODULE_1__["getDate"])(url).then(function (res) {
...
/* harmony import */ var _services_reqests__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/reqests */ "./src/js/services/reqests.js");
...
var drop = function drop() {
  var fileInputs = document.querySelectorAll('[name="upload"]'); // const fileLoad = document.querySelectorAll('.file_upload > div');
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      input.files = e.dataTransfer.files; // console.log(input.files[0]);
      ...
      if (input.closest('.file-upload-fetch')) {
        ...
        Object(_services_reqests__WEBPACK_IMPORTED_MODULE_8__["postDate"])('assets/server.php', formDate).then(function (res) {
          return console.log(res);
        });
      }

      var fileName = input.files[0].name.split('.'); //сторюється масив з двох елементів :назва картинки і розширення

      var dots;
      fileName[0].length > 5 ? dots = '...' : dots = '.';
      var name = fileName[0].slice(0, 6) + dots + fileName[1];
...
var filterImage = function filterImage() {
  var header = document.querySelector('.portfolio-menu');
  var portfolioItem = document.querySelectorAll('.portfolio-block');
...
/* harmony default export */ __webpack_exports__["default"] = (filterImage);
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _services_reqests__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../services/reqests */ "./src/js/services/reqests.js");
...
var forms = function forms(costPicture) {
  ...
  var fileInput = document.querySelectorAll('input[type="file"]'); // всі інпути  в які завантажуються картинки

  var fileLoad = document.querySelectorAll('.file_upload > div'); // блок куди записується імя завантажуваного файла 

  var size = document.querySelector('#size');
  var material = document.querySelector('#material');
  var options = document.querySelector('#options');
  var resultSumCalc = document.querySelector('.calc-price');
  fileInput.forEach(function (item, i) {
    item.addEventListener('input', function () {
      // console.log(item.files);
      var fileName = item.files[0].name.split('.'); //сторюється масив з двох елементів :назва картинки і розширення
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_reqests__WEBPACK_IMPORTED_MODULE_7__["postDate"])(api, formDate).then(function (res) {
        console.log(res);
...
/*!**********************************!*\
  !*** ./src/js/modules/modals.js ***!
  \**********************************/
/*! exports provided: closeAllModal, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var modals = function modals() {
  ...
  bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); // showModalByTime('.popup-consultation', 4000);
};
    ...
    link.addEventListener('click', function (event) {
      ...
      if (link.hash.length > 1) {
        ...
        var step = function step(time) {
          ...
          var r = toBlock < 0 ? Math.max(heightTop - progress / speed, 0) : Math.min(heightTop + progress / speed, toBlock);
          window.scrollTo(0, r);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  var stylesRow = document.querySelector(wrapper);
  var button = document.querySelector(trigger);

  var drawCards = function drawCards(res) {
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(Object(_services_reqests__WEBPACK_IMPORTED_MODULE_6__["getDate"])('http://localhost:3000/styles').then(drawCards).catch(function (e) {
  ...
  block.forEach(function (block) {
    block.addEventListener('mouseenter', function () {
      block.children.forEach(function (child) {
        ...
        if (tagName != 'IMG' && className != 'sizes-hit') {
...
var slider = function slider(slides, dir, prev, next) {
  var slideIndex = 1;
  var paused = false;
  var items = Array.from(document.querySelectorAll(slides));
...
/*!************************************!*\
  !*** ./src/js/services/reqests.js ***!
  \************************************/
/*! exports provided: getDate, postDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getDate = function getDate(url) {
  var res;
  return regeneratorRuntime.async(function getDate$(_context2) {
    while (1) {
